...
set "maxbytesize=440"
set "loader_s=%projectdir%\NUCLEO-U575ZI-Q_S\Exe\Project.bin"
set "loader_ns=%projectdir%\NUCLEO-U575ZI-Q_NS\Exe\Project.bin"
...
set "nsclib_source=%projectdir%\NUCLEO-U575ZI-Q_S\Exe\Project_import_lib.o"
